...
console.log(0.00000000005, parseInt(0.00000000005, 10)); // 5
...
console.log(parseFloat('5.000000000000000000001'));

console.log(parseFloat('5.1')); // 5.1
console.log(parseFloat('5.000000000001')); // 5.000000000001
